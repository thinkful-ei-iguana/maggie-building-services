...
VALUES
  ...
  ('West',      '2018-01-29 11:00:00',       'Mans not torrid'),
  ...
  ('West',      now() - '29 days'::INTERVAL, 'Mans not torrid'),
  ...
  ('Midwest ',  now() - '28 days'::INTERVAL, 'Mans not torrid'),
  ('South',     now() - '28 days'::INTERVAL, 'Despotato'),
  ('West',      now() - '28 days'::INTERVAL, 'UpTown Monk'),
  ('Northeast', now() - '28 days'::INTERVAL, 'UpTown Monk'),
  ('Midwest ',  now() - '26 days'::INTERVAL, 'Mans not torrid'),
  ...
  ('West',      now() - '13 days'::INTERVAL, 'Mans not torrid'),
  ('West ',     now() - '12 days'::INTERVAL, 'Mans not torrid'),
  ('Midwest ',  now() - '12 days'::INTERVAL, 'Mans not torrid'),
  ('West',      now() - '12 days'::INTERVAL, 'Mans not torrid'),
  ...
  ('South',     now() - '3 days'::INTERVAL,  'Mans not torrid'),
  ('South',     now() - '2 days'::INTERVAL,  'Mans not torrid'),
